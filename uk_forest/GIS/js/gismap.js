...
var layers = {
    ...
    'basemap_ortho': new ol.layer.Tile({
        ...
        visible: false,
        source: new ol.source.TileWMS({
            url: 'http://203.92.32.34:9012/geoserver/mongala/wms?',
            params: {
                'FORMAT': format,
                'VERSION': '1.3.0',
                tiled: true,
    ...
    'risala_ortho': new ol.layer.Tile({
    type: 'base',
    visible: false,
    source: new ol.source.TileWMS({
        url: 'http://203.92.32.34:9012/geoserver/mongala/wms?',
...
function funplantation(checkbox) {

    if (checkbox.checked) {
        jQuery('#div_plantation').css('display', 'block');
        map.addLayer(plantation_layer);
        layerobject.push(plantation_layer);
        map.addOverlay(plantation_layer);
        lastselectedlayer.push("tbl_plantation_area");
        lastselectedlayername.push("Plantation Bageshwar");
        lastselectedlayer_vector.push("tbl_plantation_area");
        //village_zoom();
    }
    else {
        jQuery('#div_plantation').css('display', 'none');
        map.removeLayer(plantation_layer);
        layerobject.pop(plantation_layer);
        map.removeOverlay(plantation_layer);
        lastselectedlayer.pop("tbl_plantation_area");
        lastselectedlayername.pop("Plantation Bageshwar");
...
function forestDensity(checkbox) {
...
var forest_Density = new ol.layer.Image({
    source: new ol.source.ImageWMS({
        ratio: 1,
        url: geoserver_ip,
        params: {
...
function populationdensity(checkbox) {
    ...
    if (checkbox.checked) {
        ...
        lastselectedlayername.push("Population Status (2011)");
        ...
        lastselectedlayername.pop("Population Status (2011)");
...
function rivers_fn(checkbox) {
    ...
    if (checkbox.checked) {
        ...
        lastselectedlayername.push("Drainage");
        ...
        lastselectedlayername.pop("Drainage");
...
function forestfirepoints2024(checkbox) {
    
 
    if (checkbox.checked) {
       // jQuery('#div_fire_points2024').css('display', 'block');
        map.addLayer(forest_fire_points2024);
        layerobject.push(forest_fire_points2024);
        map.addOverlay(forest_fire_points2024);
        lastselectedlayer.push("tbl_2024");
        lastselectedlayername.push("Fire Points 2024");
        lastselectedlayer_vector.push("tbl_2024");
        //village_zoom();
    }
    else {
       // jQuery('#div_fire_points2024').css('display', 'none');
        map.removeLayer(forest_fire_points2024);
        layerobject.pop(forest_fire_points2024);
        map.removeOverlay(forest_fire_points2024);
        lastselectedlayer.pop("tbl_2024");
        lastselectedlayername.pop("Fire Points 2024");
        lastselectedlayer_vector.pop("tbl_2024");
    }
}
...
function forestfirepoints2023(checkbox) {
    ...
    if (checkbox.checked) {
        jQuery('#div_fire_points2023').css('display', 'block');
        map.addLayer(forest_fire_points2023);
        layerobject.push(forest_fire_points2023);
        map.addOverlay(forest_fire_points2023);
        lastselectedlayer.push("tbl_2023");
        lastselectedlayername.push("Fire Points 2023");
        lastselectedlayer_vector.push("tbl_2023");
        //village_zoom();
    }
    else {
        jQuery('#div_fire_points2023').css('display', 'none');
        map.removeLayer(forest_fire_points2023);
        layerobject.pop(forest_fire_points2023);
        map.removeOverlay(forest_fire_points2023);
        lastselectedlayer.pop("tbl_2023");
        lastselectedlayername.pop("Fire Points 2023");
        lastselectedlayer_vector.pop("tbl_2023");
    }
}
...
function forestfirepoints2022(checkbox) {
    ...
    if (checkbox.checked) {
        jQuery('#div_fire_points2022').css('display', 'block');
        map.addLayer(forest_fire_points2022);
        layerobject.push(forest_fire_points2022);
        map.addOverlay(forest_fire_points2022);
        lastselectedlayer.push("tbl_2022");
        lastselectedlayername.push("Fire Points 2022");
        lastselectedlayer_vector.push("tbl_2022");
        //village_zoom();
    }
    else {
        jQuery('#div_fire_points2022').css('display', 'none');
        map.removeLayer(forest_fire_points2022);
        layerobject.pop(forest_fire_points2022);
        map.removeOverlay(forest_fire_points2022);
        lastselectedlayer.pop("tbl_2022");
        lastselectedlayername.pop("Fire Points 2022");
        lastselectedlayer_vector.pop("tbl_2022");
    }
}
...
function forestfirepoints2021(checkbox) {
    ...
    if (checkbox.checked) {
        jQuery('#div_fire_points2021').css('display', 'block');
        map.addLayer(forest_fire_points2021);
        layerobject.push(forest_fire_points2021);
        map.addOverlay(forest_fire_points2021);
        lastselectedlayer.push("tbl_2021");
        lastselectedlayername.push("Fire Points 2021");
        lastselectedlayer_vector.push("tbl_2021");
        //village_zoom();
    }
    else {
        jQuery('#div_fire_points2021').css('display', 'none');
        map.removeLayer(forest_fire_points2021);
        layerobject.pop(forest_fire_points2021);
        map.removeOverlay(forest_fire_points2021);
        lastselectedlayer.pop("tbl_2021");
        lastselectedlayername.pop("Fire Points 2021");
        lastselectedlayer_vector.pop("tbl_2021");
    }
}
...
function forestfirepoints2020(checkbox) {
    ...
    if (checkbox.checked) {
        jQuery('#div_fire_points2020').css('display', 'block');
        map.addLayer(forest_fire_points2020);
        layerobject.push(forest_fire_points2020);
        map.addOverlay(forest_fire_points2020);
        lastselectedlayer.push("tbl_2020");
        lastselectedlayername.push("Fire Points 2020");
        lastselectedlayer_vector.push("tbl_2020");
        //village_zoom();
    }
    else {
        jQuery('#div_fire_points2020').css('display', 'none');
        map.removeLayer(forest_fire_points2020);
        layerobject.pop(forest_fire_points2020);
        map.removeOverlay(forest_fire_points2020);
        lastselectedlayer.pop("tbl_2020");
        lastselectedlayername.pop("Fire Points 2020");
        lastselectedlayer_vector.pop("tbl_2020");
    }
}
...
function forestfirepoints2019(checkbox) {

    if (checkbox.checked) {
        jQuery('#div_fire_points2019').css('display', 'block');
        map.addLayer(forest_fire_points2019);
        layerobject.push(forest_fire_points2019);
        map.addOverlay(forest_fire_points2019);
        lastselectedlayer.push("tbl_2019");
        lastselectedlayername.push("Fire Points 2019");
        lastselectedlayer_vector.push("tbl_2019");
        //village_zoom();
    }
    else {
        jQuery('#div_fire_points2019').css('display', 'none');
        map.removeLayer(forest_fire_points2019);
        layerobject.pop(forest_fire_points2019);
        map.removeOverlay(forest_fire_points2019);
        lastselectedlayer.pop("tbl_2019");
        lastselectedlayername.pop("Fire Points 2019");
        lastselectedlayer_vector.pop("tbl_2019");
    }
}
...
function waterbody_fun(checkbox) {

    if (checkbox.checked) {
        jQuery('#div_waterbody').css('display', 'block');
        map.addLayer(waterbodydata);
        layerobject.push(waterbodydata);
        map.addOverlay(waterbodydata);
        lastselectedlayer.push("tbl_uk_water_body");
        lastselectedlayername.push("Water Body");
        lastselectedlayer_vector.push("tbl_uk_water_body");
        //village_zoom();
    }
    else {
        jQuery('#div_waterbody').css('display', 'none');
        map.removeLayer(waterbodydata);
        layerobject.pop(waterbodydata);
        map.removeOverlay(waterbodydata);
        lastselectedlayer.pop("tbl_uk_water_body");
        lastselectedlayername.pop("Water Body");
        lastselectedlayer_vector.pop("tbl_uk_water_body");
    }
}

var waterbodydata = new ol.layer.Image({
    source: new ol.source.ImageWMS({
        ratio: 1,
        url: geoserver_ip,
        params: {
            ...
            tiled: true,
            STYLES: '',
            layers: 'uk_sfd:tbl_uk_water_body',
            transition: 0
        }, serverType: 'geoserver',
        crossOrigin: 'anonymous'
...
function railways_fun(checkbox) {

    if (checkbox.checked) {
        jQuery('#div_railways').css('display', 'block');
        map.addLayer(railwaysdata);
        layerobject.push(railwaysdata);
        map.addOverlay(railwaysdata);
        lastselectedlayer.push("tbl_uk_railway_line");
        lastselectedlayername.push("Railways Line");
        lastselectedlayer_vector.push("tbl_uk_railway_line");
        //village_zoom();
    }
    else {
        jQuery('#div_railways').css('display', 'none');
        map.removeLayer(railwaysdata);
        layerobject.pop(railwaysdata);
        map.removeOverlay(railwaysdata);
        lastselectedlayer.pop("tbl_uk_railway_line");
        lastselectedlayername.pop("Railways Line");
        lastselectedlayer_vector.pop("tbl_uk_railway_line");
    }
}

var railwaysdata = new ol.layer.Image({
    source: new ol.source.ImageWMS({
        ratio: 1,
        url: geoserver_ip,
        params: {
            ...
            tiled: true,
            STYLES: '',
            layers: 'uk_sfd:tbl_uk_railway_line',
            transition: 0
        }, serverType: 'geoserver',
        crossOrigin: 'anonymous'
...
function roads_fun(checkbox) {

    if (checkbox.checked) {
        jQuery('#div_road').css('display', 'block');
        map.addLayer(roadsdata);
        layerobject.push(roadsdata);
        map.addOverlay(roadsdata);
        lastselectedlayer.push("tbl_uk_road");
        lastselectedlayername.push("Roads");
        lastselectedlayer_vector.push("tbl_uk_road");
        //village_zoom();
    }
    else {
        jQuery('#div_road').css('display', 'none');
        map.removeLayer(roadsdata);
        layerobject.pop(roadsdata);
        map.removeOverlay(roadsdata);
        lastselectedlayer.pop("tbl_uk_road");
        lastselectedlayername.pop("Roads");
        lastselectedlayer_vector.pop("tbl_uk_road");
    }
}

var roadsdata = new ol.layer.Image({
    source: new ol.source.ImageWMS({
        ratio: 1,
        url: geoserver_ip,
        params: {
...
function railwaystation_fun(checkbox) {

    if (checkbox.checked) {
        jQuery('#div_railwaystation').css('display', 'block');
        map.addLayer(railwaystation);
        layerobject.push(railwaystation);
        map.addOverlay(railwaystation);
        lastselectedlayer.push("tbl_railway_station");
        lastselectedlayername.push("Railway Station");
        lastselectedlayer_vector.push("tbl_railway_station");
        //village_zoom();
    }
    else {
        jQuery('#div_railwaystation').css('display', 'none');
        map.removeLayer(railwaystation);
        layerobject.pop(railwaystation);
        map.removeOverlay(railwaystation);
        lastselectedlayer.pop("tbl_railway_station");
        lastselectedlayername.pop("Railway Station");
        lastselectedlayer_vector.pop("tbl_railway_station");
    }
}

var railwaystation = new ol.layer.Image({
    source: new ol.source.ImageWMS({
        ratio: 1,
        url: geoserver_ip,
        params: {
            ...
            tiled: true,
            STYLES: '',
            layers: 'uk_sfd:tbl_railway_station',
            transition: 0
        }, serverType: 'geoserver',
        crossOrigin: 'anonymous'
...
function block_fun(checkbox) {

    if (checkbox.checked) {
        jQuery('#div_block').css('display', 'block');
        map.addLayer(blockdata);
        layerobject.push(blockdata);
        map.addOverlay(blockdata);
        lastselectedlayer.push("tbl_block_areas");
        lastselectedlayername.push("Blocks");
        lastselectedlayer_vector.push("tbl_block_areas");
        //village_zoom();
    }
    else {
        jQuery('#div_block').css('display', 'none');
        map.removeLayer(blockdata);
        layerobject.pop(blockdata);
        map.removeOverlay(blockdata);
        lastselectedlayer.pop("tbl_block_areas");
        lastselectedlayername.pop("Blocks");
        lastselectedlayer_vector.pop("tbl_block_areas");
    }
}

var blockdata = new ol.layer.Image({
    source: new ol.source.ImageWMS({
        ratio: 1,
        url: geoserver_ip,
        params: {
...
var srtm_layer = new ol.layer.Image({
    source: new ol.source.ImageWMS({
        ratio: 1,
        url: geoserver_ip,
        params: {
            ...
            tiled: true,
            STYLES: '',
            layers: 'thailand:Uttaranchal_SRTM_GEO',
            transition: 0
        }
...
function majorcity_fun(checkbox) {

    if (checkbox.checked) {
        jQuery('#div_majorcity').css('display', 'block');
        map.addLayer(majorcity);
        layerobject.push(majorcity);
        map.addOverlay(majorcity);
        lastselectedlayer.push("tbl_major_city");
        lastselectedlayername.push("Major Cities");
        lastselectedlayer_vector.push("tbl_major_city");
        //village_zoom();
    }
    else {
        jQuery('#div_majorcity').css('display', 'none');
        map.removeLayer(majorcity);
        layerobject.pop(majorcity);
        map.removeOverlay(majorcity);
        lastselectedlayer.pop("tbl_major_city");
        lastselectedlayername.pop("Major Cities");
        lastselectedlayer_vector.pop("tbl_major_city");
    }
}

var majorcity = new ol.layer.Image({
    source: new ol.source.ImageWMS({
        ratio: 1,
        url: geoserver_ip,
        params: {
