...
class App {
    initComponents() {
        ...
        // Fixed toast placement initialization with proper null checks
        const toastEl = document.getElementById("toastPlacement");
        const selectToast = document.getElementById("selectToastPlacement");
        if (toastEl && selectToast) {
            selectToast.addEventListener("change", function () {
                toastEl.dataset.originalClass || (toastEl.dataset.originalClass = toastEl.className);
                toastEl.className = toastEl.dataset.originalClass + " " + this.value;
            });
        }
        ...
        t && t.addEventListener("click", () => {
            const e = "Nice, you triggered this alert message!",
                t = "success";
...
class ThemeCustomizer {
    ...
    initSwitchListener() {
        ...
        const lightDarkToggle = document.getElementById("light-dark-mode");
        if (lightDarkToggle) {
            lightDarkToggle.addEventListener("click", function (e) {
                const currentTheme = a.html.getAttribute("data-bs-theme");
                const newTheme = currentTheme === "light" ? "dark" : "light";
                a.changeLayoutColor(newTheme);
            });
        }

        document.querySelector("#reset-layout")?.addEventListener("click", function (e) {
            a.resetTheme();
        });

        document.querySelector(".sidenav-toggle-button")?.addEventListener("click", function () {
...
/*
let addDetails = document.querySelector(".sidenav-menu");
let dashbordBoxs = document.querySelector(".page-content");
let topBarMargin = document.querySelector(".app-topbar");
let logoIconD = document.querySelector(".logoIconBox");
let imgHideVisible = document.querySelector(".logo-light")

let clickHereBtn = document.querySelector(".toggleBtnBox");

clickHereBtn.addEventListener("click", function () {
    addDetails.classList.toggle("collapsWidth");
    dashbordBoxs.classList.toggle("dashbordMarginLeft");
    topBarMargin.classList.toggle("topMarginLeft");
    logoIconD.classList.toggle("logoIconBox");
    imgHideVisible.classList.toggle("hidePictureLogo");
