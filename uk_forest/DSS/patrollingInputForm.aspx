...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div>
                <div class="row align-items-stretch">
                    <div class="col-md-6 form-section">
                        ...
                        <div class="mb-3">
                            <asp:RadioButtonList ID="rblTrackType" CssClass="form-check-inline" RepeatDirection="Horizontal"
                                ...
                                <asp:ListItem Text="Existing Track" Value="Defined" Selected="True" />
                            </asp:RadioButtonList>
                        </div>
                        ...
                        <asp:Panel ID="pnlDefinedTrackFields" runat="server">
                            <div class="mb-3">
                                ...
                                <asp:DropDownList ID="ddlDefinedTrack" CssClass="form-select" runat="server" onchange="shoe()">
                                    <asp:ListItem Text="Select Existing Track" Value="" />
                                </asp:DropDownList>
                            ...
                            <asp:Panel ID="pnlKML" runat="server" Visible="true">
                                <div class="mb-3">
                                    <asp:Label CssClass="form-label" runat="server" Text="Patrolled Track" />
                    ...
                    <div class="col-md-6 d-flex flex-column">
                        ...
                        <div id="map" style="flex:1; min-height:280px;"></div>
                        <div id="output"></div>
                    </div>
                </div>
            </div>
  ...
  <script>
      ...
      function shoe() {
          ...
          var trackId = document.getElementById("ContentPlaceHolder1_ddlDefinedTrack").value;
