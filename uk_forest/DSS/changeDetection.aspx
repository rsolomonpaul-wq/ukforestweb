<%@ Page Title="" Language="C#" MasterPageFile="~/Forest/forestmaster.Master" AutoEventWireup="true" CodeBehind="changeDetection.aspx.cs" Inherits="uk_forest.DSS.changeDetection" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="map-style-flood" id="map" style="margin-top:12px;    height: 91vh;">
         <div style="border: 2px solid #e5d9d9; position: absolute; z-index: 1; bottom: 0; width: 100%; height: 150px; padding: 5px;background-color: white;">
                                <div>dfgdf</div>
                            </div>
    </div>
 <%--    <div > 
                    <div class="map-style-flood" id="map" style="margin-top:12px;    height: 91vh;">
                        ...
                        <div class="layer-switcher" style="z-index: 11; background-color: white !important;">
                            ...
                            <div>
                                ...
                                <label>
                                    <input type="radio" name="layer" value="sentinel2" />
                                    Sentinel-2
                                </label>
                        ...
                        <div>
                            ...
                            <div style="border: 2px solid red; position: absolute; z-index: 1; bottom: 0; width: 100%; height: 150px; padding: 5px;background-color: white;">
                                <div>dfgdf</div>
                            </div>
                 ...
                 <div style="display:block" class="datalayers">
                            <ul>
                                <li>
                                      <div id="swipediv" class="sldr swipetool" style="display:none">
            <input id="swipe" class="swpr" type="range" style="width: 100%" value="0" data-toggle="tooltip" title="Swipe Tool" />
        </div>
                                   
                                      <img id="layerswipe" class="icon" src="img/layer_swiper.png" title="Layer Swipe Tools" onclick='swipetool();' />
                                </li>
                                <li >
