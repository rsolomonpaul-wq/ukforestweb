<%@ Page Title="" Language="C#" MasterPageFile="~/Forest/forestmaster.Master" AutoEventWireup="true" CodeBehind="user_registration_new.aspx.cs" Inherits="uk_forest.Forest.user_registration_new" %>
                    ...
                    <div id="divHierarchy" runat="server" visible="false">
                        <div class="row">
                            ...
                            <div class="col-md-3" id="divDivision" runat="server" visible="false">
                                ...
                                <asp:DropDownList ID="ddl_division" runat="server" CssClass="dropdown-action"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
