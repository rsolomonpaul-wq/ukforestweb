...
namespace uk_forest.Forest
{
    public partial class user_registration : System.Web.UI.Page
    {
        ...
        private void BindSubDivisions(Int32 divisionId = 0)
        {
            try
            {
                if (divisionId == 0)
                {
                    ddl_sub_division.Items.Clear();
                    ddl_sub_division.Items.Insert(0, new System.Web.UI.WebControls.ListItem("-- Select Sub-Division --", "0"));
                }
                else
                {
                    string url = apiUrl + "TblSubDivisionMasters/GetTblSubDivisionMasterBydivisionId?division_id=" + divisionId;
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        ...
                        DataTable dt = JsonConvert.DeserializeObject<DataTable>(result);
                        ddl_sub_division.Items.Clear();
                        ddl_sub_division.DataSource = dt;
                        ddl_sub_division.DataValueField = "SubDivisionId";
                        ddl_sub_division.DataTextField = "SubDivisionName";
                        ddl_sub_division.DataBind();
                        ddl_sub_division.Items.Insert(0, new System.Web.UI.WebControls.ListItem("-- Select Sub-Division --", "0"));
                    }
                }
            ...
            {
                ShowError("Error loading Sub-Divisions: " + ex.Message);
            }
        }
        private void BindRange(Int32 divisionId = 0, Int32 subdivisionId = 0)
        {
            try
            {
                if (divisionId == 0)
                {
                    ...
                    ddl_range.Items.Insert(0, new System.Web.UI.WebControls.ListItem("-- Select Range --", "0"));
                }
                else
                {
                    string url = apiUrl + "TblRangeMasters/GetTblRangeMasterBysubdivisionId?division_id=" + divisionId + "&sub_division_id=" + subdivisionId;
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        ...
                        ddl_range.DataValueField = "RangeId";
                        ddl_range.DataTextField = "RangeName";
                        ddl_range.DataBind();
                        ddl_range.Items.Insert(0, new System.Web.UI.WebControls.ListItem("-- Select Range --", "0"));
                    }
                }
            ...
            {
                ShowError("Error loading Ranges: " + ex.Message);
            }
        }
                    ...
                    if (!dt.Columns.Contains("RoleName"))
                    {
                        ...
                        foreach (DataRow row in dt.Rows)
                        {
                            switch (row["RoleId"].ToString())
                            {
                                ...
                                case "9": row["RoleName"] = "SDO"; break;
                                case "10": row["RoleName"] = "RO"; break;
            ...
            if (!string.IsNullOrEmpty(selectedRoleValue))
            {
                ...
                switch (selectedRoleValue)
                {
                    ...
                    case "5": // APCCF
                        ...
                        ListItem itemToHideDFO = rbl_reporting_to.Items.FindByValue("DFO");
                        itemToHideDFO.Attributes["style"] = "display:none";

                        ListItem itemToHideSDO = rbl_reporting_to.Items.FindByValue("SDO");
                        itemToHideSDO.Attributes["style"] = "display:none";
                    ...
                    case "6": // CCF
                        ...
                        ListItem itemToHideDFO1 = rbl_reporting_to.Items.FindByValue("DFO");
                        itemToHideDFO1.Attributes["style"] = "display:none";

                        ListItem itemToHideSDO1 = rbl_reporting_to.Items.FindByValue("SDO");
                        itemToHideSDO1.Attributes["style"] = "display:none";
                    ...
                    case "7": // CF
                        ...
                        ListItem itemToHideDFO2 = rbl_reporting_to.Items.FindByValue("DFO");
                        itemToHideDFO2.Attributes["style"] = "display:none";

                        ListItem itemToHideSDO2 = rbl_reporting_to.Items.FindByValue("SDO");
                        itemToHideSDO2.Attributes["style"] = "display:none";
                    ...
                    case "8": // DFO
                        ...
                        ListItem itemToHideDFO3 = rbl_reporting_to.Items.FindByValue("DFO");
                        itemToHideDFO3.Attributes["style"] = "display:none";

                        ListItem itemToHideSDO3 = rbl_reporting_to.Items.FindByValue("SDO");
                        itemToHideSDO3.Attributes["style"] = "display:none";
                    ...
                    case "9": // SDO
                        ...
                        rbl_reporting_to.SelectedValue = "DFO";
                        divHoff.Visible = true;


                        divReporting.Visible = true;
                        ListItem itemToHideHOFF9 = rbl_reporting_to.Items.FindByValue("HOFF");
                        itemToHideHOFF9.Attributes["style"] = "display:none";
                        ListItem itemToHidePCCF9 = rbl_reporting_to.Items.FindByValue("PCCF");
                        itemToHidePCCF9.Attributes["style"] = "display:none";
                        ListItem itemToHideAPCCF9 = rbl_reporting_to.Items.FindByValue("APCCF");
                        itemToHideAPCCF9.Attributes["style"] = "display:none";
                        ListItem itemToHideCCF9 = rbl_reporting_to.Items.FindByValue("CCF");
                        itemToHideCCF9.Attributes["style"] = "display:none";
                        ListItem itemToHideCF9 = rbl_reporting_to.Items.FindByValue("CF");
                        itemToHideCF9.Attributes["style"] = "display:none";
                        ListItem itemToHideSDO9 = rbl_reporting_to.Items.FindByValue("SDO");
                        itemToHideSDO9.Attributes["style"] = "display:none";
                    ...
                    case "10": // RO
                        ...
                        divReporting.Visible = true;
                        ListItem itemToHideHOFF10 = rbl_reporting_to.Items.FindByValue("HOFF");
                        itemToHideHOFF10.Attributes["style"] = "display:none";
                        ListItem itemToHidePCCF10 = rbl_reporting_to.Items.FindByValue("PCCF");
                        itemToHidePCCF10.Attributes["style"] = "display:none";
                        ListItem itemToHideAPCCF10 = rbl_reporting_to.Items.FindByValue("APCCF");
                        itemToHideAPCCF10.Attributes["style"] = "display:none";
                        ListItem itemToHideCCF10 = rbl_reporting_to.Items.FindByValue("CCF");
                        itemToHideCCF10.Attributes["style"] = "display:none";
                        ListItem itemToHideCF10 = rbl_reporting_to.Items.FindByValue("CF");
                        itemToHideCF10.Attributes["style"] = "display:none";
                        ...
                        else if (reportingTo == "SDO")
                        {
                            rbl_reporting_to.SelectedValue = "SDO";
                            divHoff.Visible = false;
                            divPccf.Visible = false;
                            divApccf.Visible = false;
                            divCcf.Visible = false;
        ...
        protected void ddl_division_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                //BindDfos(8, Convert.ToInt32(ddl_division.SelectedValue));
                BindSubDivisions(Convert.ToInt32(ddl_division.SelectedValue));
                string selectedReportingTo = rbl_reporting_to.SelectedValue;
                UpdateUIForSelectedRole(ddl_role.SelectedValue, selectedReportingTo);
            }
        }
        protected void ddl_sub_division_SelectedIndexChanged(object sender, EventArgs e)
        {
            BindRange();
            if (!string.IsNullOrEmpty(ddl_sub_division.SelectedValue))
            {
                BindRange(Convert.ToInt32(ddl_sub_division.SelectedValue));
                string selectedReportingTo = rbl_reporting_to.SelectedValue;
                UpdateUIForSelectedRole(ddl_role.SelectedValue, selectedReportingTo);
            }
        }
        ...
        public string add_user_name(string name, string mobileNo, string emailId, Int32 roleId, Int32 zoneId, Int32 circleId, Int32 divisionId, Int32 subdivisionId, Int32 rangeId, string password, string otp, string groupId, Int32 groupRoleId, string status, string createdBy)
        {
            try
            {
                var userData = new
            ...
            try
            {
                if (ValidateInputs())
                {
                    ...
                    switch (ddl_role.SelectedValue)
                    {
                        ...
                        case "9": // SDO
                            if (rbl_reporting_to.SelectedValue == "DFO")
                            {
                                groupId = ddl_sub_division.SelectedValue;
                                grouproleId = 8;
                            }
                            divisionId = ddl_division.SelectedValue;
                            break;
                        ...
                        case "10": // RO
                            ...
                            else if (rbl_reporting_to.SelectedValue == "SDO")
                            {
                                groupId = ddl_range.SelectedValue;
                                grouproleId = 9;
                            }
                            break;
                    ...
                    if (string.IsNullOrEmpty(ddl_sub_division.SelectedValue))
                        ...
                        SubDivisionId = Convert.ToInt32(ddl_sub_division.SelectedValue);

                    int RangeId = 0;
                    if (string.IsNullOrEmpty(ddl_range.SelectedValue))
                        RangeId = 0;
                    else
                        RangeId = Convert.ToInt32(ddl_range.SelectedValue);
                    ...
                    if (string.IsNullOrEmpty(currentUserId))
                    {
                        ...
                        // Create new user
                        string result = add_user_name(txt_name.Text, txt_mobile.Text, txt_email.Text, Convert.ToInt32(ddl_role.SelectedValue), Convert.ToInt32(ddl_zone.SelectedValue), CircleId, DivisionId, SubDivisionId, RangeId, password, "1", groupId, grouproleId, status, Session["UserId"].ToString());
        ...
        private void ResetForm()
        {
            ...
            ddl_sub_division.SelectedIndex = 0;
            ...
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    switch (user.roleId.ToString())
                    {
                        ...
                        case "9": // SDO
                            rbl_reporting_to.SelectedValue = "DFO";
                            ddl_hoff.SelectedValue = user.groupId; // agar required ho
                            ddl_zone.SelectedValue = user.zoneId.ToString();
                            BindCircles(Convert.ToInt32(ddl_zone.SelectedValue));
                            ddl_circle.SelectedValue = user.circleId.ToString();
                            BindDivisions(Convert.ToInt32(ddl_circle.SelectedValue));
                            ddl_division.SelectedValue = user.divisionId.ToString();
                            BindSubDivisions(Convert.ToInt32(ddl_division.SelectedValue));
                            ddl_sub_division.SelectedValue = user.subDivisionId.ToString();
                            break;
                        ...
                        case "10": // RO
                            ...
                            BindDivisions(Convert.ToInt32(ddl_circle.SelectedValue));
                            ddl_division.SelectedValue = user.divisionId.ToString();
                            // Agar sub-division & range required ho toh yahan bind karo
                            BindSubDivisions(Convert.ToInt32(ddl_division.SelectedValue));
                            ddl_sub_division.SelectedValue = user.subDivisionId.ToString();
                            BindRange(Convert.ToInt32(ddl_sub_division.SelectedValue));
                            ddl_range.SelectedValue = user.rangeId.ToString();
                            break;
        ...
        private void DisableControls()
        {
            ...
            if (a == "View")
            {
                ...
                ddl_sub_division.Enabled = false;
        ...
        //private void BindDfos(Int32 role_id = 0, Int32 division_id = 0)
        //{
        //    try
        //    {
        //        string url = apiUrl + "TblUserRegistrations/GetDFO_byDivisionId?role_id=" + role_id + "&division_id=" + division_id;
        ...
        //            {
        //                ddl_sub_division.Items.Clear();
        //                ddl_sub_division.Items.Insert(0, new System.Web.UI.WebControls.ListItem("-- Select DFO --", ""));
        //            }
        //            else if (response.IsSuccessStatusCode)
        //            {
        //                string result = response.Content.ReadAsStringAsync().Result;
        ...
        //                ddl_sub_division.DataSource = dt;
        //                ddl_sub_division.DataValueField = "UserId";
        //                ddl_sub_division.DataTextField = "Name";
        //                ddl_sub_division.DataBind();
        //                ddl_sub_division.Items.Insert(0, new System.Web.UI.WebControls.ListItem("-- Select DFO --", ""));
        //            }
        //        }
        ...
        //    catch (Exception ex)
        //    {
        //        ShowError("Error loading DFOs: " + ex.Message);
        //    }
        //}

        //private void BindSdos(Int32 role_id = 0, string user_id = "0")
        //{
        //    try
        //    {
        //        string url = apiUrl + "TblUserRegistrations/GetUsersByRole?role_id=" + role_id + "&user_id=" + user_id;
